...
public class ClienteDAOImpl implements ClienteDAO {
	...
	// M�todo que se encarga de cerrar la conexi�n con la base de datos
	...
	public void insertarCliente(Cliente cliente) throws DAOException, SQLException {
		...
		try {
			...
			if (statement != null) {
				// Liberamos los recursos asignados al statement y a la conexi�n jdbc
				statement.close();
				this.close();
			}
		}
				...
				if (rs.next()) {
					...
					try {
						if (tipo_cliente.equals(CLIENTE_ESTANDAR)) {
							...
							// TODO: POSIBLE CASO PARA LANZAR UNA EXCEPCI�N PERSSONALIZADA
							// (Se tiene que en las tablas de bd un cliente se ha relacionado con un tipo
							// que no est� contemplando en el modelo)
							cliente.toString();
							System.out
									.println("El cliente tiene asignado un tipo de cliente no soportado por el modelo. "
											+ "Debe ser \"estandar\" o \"premium\", ya que son los �nicos tipos de cliente soportados por el momento."
